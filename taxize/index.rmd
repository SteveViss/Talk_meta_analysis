...
2. Change the provider (`data_source_ids` argument) in favor to Tropica and see what happen.
3. Try getting higher taxonomic information for your own species list.
